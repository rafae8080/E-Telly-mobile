...
// import 'package:e_telly_app/screens/walkie_talkie_screen.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          const BottomNavigationBarItem(icon: Icon(Icons.map), label: 'Evac Nav'),
      ...
      //     Navigator.push(
      //       context,
      //       MaterialPageRoute(builder: (context) => const WalkieTalkieScreen()),
      //     );
      //   },
